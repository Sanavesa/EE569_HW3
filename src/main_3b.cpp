...
int main(int argc, char *argv[])
{
    ...
    filters1.push_back(Filter(3, {0, 0, 1, 0, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {1, 0, 0, 0, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 0, 1, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 0, 0, 0, 1}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 1, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 1, 0, 0, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 1, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 0, 0, 1, 0}));
    filters1.push_back(Filter(3, {0, 0, 1, 0, 1, 1, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 1, 1, 0, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {1, 1, 0, 0, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {1, 0, 0, 1, 1, 0, 0, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 1, 1, 0, 1, 0, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 0, 1, 1, 0}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 0, 0, 1, 1}));
    filters1.push_back(Filter(3, {0, 0, 0, 0, 1, 1, 0, 0, 1}));
    ...
    {
        ApplyThinning(img, filters1, filters2, converged); // actually shrinking :P
        if (!img.ExportRAW(inputFilenameNoExtension + "_thin2_" + std::to_string(iteration + 1) + ".raw"))
            return -1;
        iteration++;
